...
- 🎯 **高准确率** - 在 100 样本基准测试中达到 72%+ 的准确率，包含置信度评分和详细推理
...
| **准确率** | 72.0% |
| **精确率** | 1.0000 |
| **召回率** | 0.2800（结论相反）/ 1.0000（完全伪造） |
| **F1 分数** | 0.4375（结论相反）/ 1.0000（完全伪造） |
| **吞吐量** | ~0.09 样本/秒 |
| **耗时** | ~18 分钟（100 样本） |

### 各类型性能

| 幻觉类型 | 准确率 | 精确率 | 召回率 | F1 分数 | 样本数 |
|-------------------|----------|-----------|--------|----------|---------|
| 完全伪造 | 100% | 1.0000 | 1.0000 | 1.0000 | 19 |
| 作者归属错误 | 100% | 1.0000 | 1.0000 | 1.0000 | 19 |
| 内容不相关 | 74% | 1.0000 | 0.7368 | 0.8485 | 19 |
| 结论相反 | 28% | 1.0000 | 0.2800 | 0.4375 | 25 |
| 真实论文 | 72% | 0.0000 | 0.0000 | 0.0000 | 18 |
